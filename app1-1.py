...
def main():
	...
	with left:
		...
		ST_Slope_radio = st.radio( "ST_Slope", list(ST_Slope_d.keys()), index=2, format_func= lambda x: ST_Slope_d[x])
	...
	data = [[ChestPainType_radio, sex_radio,  age_slider, RestingECG_radio, ExerciseAngina_radio, ST_Slope_radio, RestingBP_slider, Cholesterol_slider, MaxHR_slider]]
